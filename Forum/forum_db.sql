...
--
-- Host: 127.0.0.1
-- Czas generowania: 14 Lut 2018, 23:25
...
(5, 'wyslij cv na email praca@gmail.com', '2018-02-14 20:55:58', NULL, 1, 3),
(6, 'Donec at ornare nisi. Nullam sed ante ligula. Mauris ac ultricies arcu.', '2018-02-14 21:31:24', NULL, 2, 5),
(7, 'Suspendisse faucibus velit at nisl maximus, at tincidunt dolor finibus. Donec non viverra tellus. Integer faucibus eu orci a dictum. Nam dignissim pellentesque interdum.', '2018-02-14 21:31:53', NULL, 1, 5),
(8, 'tak', '2018-02-14 23:02:47', NULL, 13, 4);
...
(1, 'szukam pracy na terenie rzeszowa', '2018-02-14 18:01:47', 'szukam pracy', 42, 1, 3),
...
(8, ' Nullam sed ante ligula.', '2018-02-14 22:05:29', ' Nullam sed ante ligula.', 0, 3, 5),
...
CREATE TABLE `users` (
  `id` bigint(20) NOT NULL,
  `avatar_path` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
